    ...
    <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">+254 (712) 345-6789</p>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <form className="space-y-6">
          ...
          <div>
            ...
            <input type="text" value="+254 (712) 345-6789" className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          <div>
            <label className="block text-gray-700 text-sm font-semibold">Address</label>
            <input type="text" value="Machakos" className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
