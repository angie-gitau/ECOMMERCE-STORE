  ...
  return (
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[40px]">
      ...
      <div className="flex justify-between py-[5%]">
        <div>
          <img src="/logo1.jpg" alt="" height={200} width={200} />
          <p className="mt-2"> LET'S MAKE YOU GROW</p>
        </div>
        ...
        <div className="w-full md:w-1/3">
          <h2 className="taxt-xl font-semibold">Contact us</h2>
          <p className="mt-2">Nairobi</p>
          <p className="mt-2">0712345678</p>
          <p className="mt-2">bsclmr182821@gmail.com</p>
        </div>
      </div>
      {/**LOWER PART**/}
      <div className="mt-8 border-t border-orange-600 pt-4 text-center">
        <p>&copy; 2025 BuildPrime. All rights reserved.</p>
